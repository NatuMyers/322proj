...
{
   public static String[][] read(String args) throws Exception
   {
	   
	   //Takes the file name
	   String csvToRead = args;
	   
	  
		// Arguments must end in .csv, otherwise terminate program
	   if (csvToRead.endsWith(".csv") == false) {
		   System.err.println("argument must end in .csv");
		   System.exit(1);
	   }
      //Build reader instance
      //Read csvToRead
      CSVReader reader = new CSVReader(new FileReader(csvToRead));
